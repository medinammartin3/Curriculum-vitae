...
\section{Éducation}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Baccalauréat en Informatique | Bourse d'exemption}{Sep. 2022 -- Avr. 2025 (prévu)}
    \resumeSubheading
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Retour positif de la part des étudiants, indiquant que les explications et exercices ont aidé à comprendre la matière du cours et, en conséquence, à améliorer leur résultats. Retour très positif des professeurs, entraînant une réembauche dans plusieurs occasions.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      {Chargé d'atelier d'informatique en Python -- École d'été}{Juillet 2024}
      {Université de Montréal}{Montréal, Canada}
      \resumeItemListStart
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Utilisation de Django en raison de ses fonctionnalités intégrées pour la gestion de l'authentification des utilisateurs et l'enregistrement des données, et pour favoriser un développement efficace.}
          ...
          \resumeItemListStart
            \resumeItem{Implémentation de la partie front-end d‘un site web intéractif de commerce en ligne.}
            \resumeItem{Utilisation de AJAX pour mettre à jour et afficher dynamiquement les informations des produits sur le site Web, améliorant l'expérience utilisateur en réduisant les rechargements de page et en fournissant des données en temps réel.}
            \resumeItem{\textbf{Lien vers le site Web}: \href{https://medinammartin3.github.io/OnlineShop/index.html}{\underline{https://medinammartin3.github.io/OnlineShop/index.html}}}
          ...
          \resumeItemListStart
            ...
            \resumeItem{Gestion des comptes des vendeurs et des acheteurs. Toutes les informations telles que commandes réalisées et produits en vente, sont enregistrées et préservées pour chaque utilisateur.}
            \resumeItem{Utilisation de JUnit pour la réalisation des tests unitaires et éviter des bugs causées par les nouvelles actualisations.}
          ...
          \resumeProjectHeading
          {\textbf{Application d'inscription de cours pour étudiants} $|$ \emph{Java, JavaFX, Maven}}{Hiver 2023}
          \resumeItemListStart
            ...
            \resumeItem{Enregistrement des choix dans une simple base de données sous format texte.}
            \resumeItem{Utilisation de JavaFX pour la réalisation de l'interface graphique.}
          ...
          \resumeProjectHeading
          {\textbf{Site web personnel} $|$ \emph{HTML/CSS, JavaScript}}{}
          \resumeItemListStart
            \resumeItem{Site web de mon CV et mon Portfolio}
            \resumeItem{\textbf{Lien vers le site Web}: \href{https://medinammartin3.github.io}{\underline{https://medinammartin3.github.io}}}
